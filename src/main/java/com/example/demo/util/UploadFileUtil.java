...
public class UploadFileUtil {
	...
	public static String fileSave(String uploadPath, 
		...
		if (file.getInputStream() != null) {
			...
			// abc.jpg >> 9ca3-e4f26aa85 >> 9ca3-e4f26aa85.jpg
			// abc.ccc.eee.jpg
			// 파일명을 랜덤하게 변경 (중복 방지)
	...
	public static String makeFilePath(
		...
		return filePath.substring(uploadPath.length())
	...
	public static String getExtension(String fileName) {
		// 파일이름 jifsdjifsdjio.geijrgijrg.grijijgrigjr.grirgtij.jpg
		// 파일이름 hjggjhg >> .이 없으면 dotPosition에 -1 출력
		// abc.jpg
